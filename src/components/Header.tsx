  ...
  return (
    <>
      ...
      <header className='flex flex-col'>
        ...
        Todos hemos experimentado la soledad en algún momento. Pero, ¿qué hay detrás de ese sentimiento? ¿En qué situaciones la has experimentado?
        ¿Cómo definirías y describirías la soledad en tu propia experiencia? Comparte tus sentimientos y vivencias de manera anónima en una carta.
        </p>
      </header>
    </>
  )
