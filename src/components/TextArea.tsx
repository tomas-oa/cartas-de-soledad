...
export default function TextArea () {
  ...
  return (
    <>
      ...
      <button type='submit' disabled={pending} className="w-9 grid place-content-center absolute bottom-4 right-5 aspect-square rounded-full border bg-[#375eb8] hover:scale-110 hover:transition-all disabled:opacity-25 focus:scale-110 focus:transition-all">
        <Send />
      </button>
    </>
  )
